...
class WatchlistItemComponent extends Component {
    ...
    render() {
        ...
        return (
            <FlatButton onTouchTap={() => changeTitle(instrument.name, {stockType: 'watchlist', symbol: instrument.symbol, hasBackButton: true})} backgroundColor="#303030" hoverColor="#434343" rippleColor='#bdbdbd' style={{width: '100%', marginBottom: 15, height: 'auto'}}>
